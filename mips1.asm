...
prompt1:    .asciiz "Hola Por favor, Ingresa el primer número: "           # Declara una cadena de caracteres como mensaje informativo para el usuario utilizando asciiz que sería de tipo string.
prompt2:    .asciiz "Por favor, Ingresa el segundo número: "               # Declara una cadena de caracteres como mensaje informativo para el usuario utilizando asciiz que sería de tipo string.
prompt3:    .asciiz "Por Favor, Ingresa el tercer número: "                # Declara una cadena de caracteres como mensaje informativo para el usuario utilizando asciiz que sería de tipo string.
result_msg: .asciiz "El número mayor es: "                                 # Declara una cadena de texto para el resultado utilizando asciiz de tipo string para el resultado del programa.                                               

all_equal_msg: .asciiz "Todos los números son iguales, el número mayor es el primero que ingresaste: "  # Declara como mensaje informativo en caso de que el usuario ingrese los 3 números iguales. 
...
main:
    ...
    bgt $s0, $s1, check_third    # Bgt es salto si es mayor que comparando los 2 primeros números ingresados por el usuario luego de esto con check_third salta al siguiente método si se cumple esta condición.
    move $t0, $s1               # Copia el valor del registro del $s1 en $t0 ya con el número mayor comparado de estos dos.

check_third:                     # En caso de que la condición de que se cumpla salta para imprimir resultado del número mayor entre los dos anteriores.
    bgt $t0, $s2, print_result   # Bgt salto condicional en caso de que $t0 sea mayor que $s2.
...
print_result:		# Imprime resultado pero entrar a verificar en caso de que los 3 números sean iguales.                            
    ...
    li $v0, 4    	# Código de servicio 4 para mostrar operación con cadenas de caracteres en el registro $v0.
    la $a0, result_msg  # Carga la dirección de la cadena result_msg para indicar el número mayor.
